...
Это приложение предоставляет RESTful API для управления заметками. 
Пользователь может создавать, читать, обновлять и удалять заметки через HTTP-запросы.
...
Например, метод create принимает POST-запрос к маршруту /api/v1/calendar/event/ и создает новую заметку. 
Метод list_ принимает GET-запрос к тому же маршруту и возвращает список всех заметок. 
